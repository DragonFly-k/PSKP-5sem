const resolver = {
  ...
  getTeachers: (args, context) => {
    return args.TEACHER? context.getOneRecord("TEACHER", args.TEACHER): context.getFullTable("TEACHER");
  },
  getPulpits: (args, context) => {
    return args.PULPIT? context.getOneRecord("PULPIT", args.PULPIT): context.getFullTable("PULPIT");
  },
  ...
  setPulpit: async (args, context) => {
    return ((await context.updateOneRecord("PULPIT", args)) ??(await context.insertOneRecord("PULPIT", args)));
  },
  setSubject: async (args, context) => {
    return ((await context.updateOneRecord("SUBJECT", args)) ??(await context.insertOneRecord("SUBJECT", args)));
  },
  delFaculty: (args, context) =>context.deleteOneRecord("FACULTY", args.FACULTY),
  delTeacher: (args, context) =>context.deleteOneRecord("TEACHER", args.TEACHER),
  delPulpit: (args, context) => context.deleteOneRecord("PULPIT", args.PULPIT),
  delSubject: (args, context) =>context.deleteOneRecord("SUBJECT", args.SUBJECT),
